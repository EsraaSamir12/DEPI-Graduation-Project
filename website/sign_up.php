...
if(isset($_POST['submit'])){  
    ...
    if($run_select === false) {
        ...
        if(empty($FullName) || empty($Email) || empty($password) || empty($confirm_pass) || empty($Nationality) || empty($CurrentLevel) || empty($Major) || empty($Gender) || empty($GPA) || empty($Country) || empty($City) || empty($DOB) || empty($YearOfStudy)){
            ...
            $insert = "INSERT INTO applicant (FullName, Email, password, Nationality, CurrentLevel, Major, Gender, GPA, Country, City, DOB, YearOfStudy) 
                       VALUES ('$FullName', '$Email', '$passwordhashing', '$Nationality', '$CurrentLevel', '$Major', '$Gender', '$GPA', '$Country', '$City', '$DOB', '$YearOfStudy')";
...
<head>
  ...
  <title>Sign Up - ScholarVerse</title>
...
<body>
  ...
  <section class="scholarship-form-section">
    ...
    <form class="scholarship-form" action="" method="post">
      <label>Full Name:</label>
      <input type="text" name="FullName" placeholder="Enter your name" value="<?php echo htmlspecialchars($FullName); ?>" required>
      ...
      <select name="YearOfStudy" required>
        ...
        <option value="1" <?php echo ($YearOfStudy == '1') ? 'selected' : ''; ?>>First Year</option>
        <option value="2" <?php echo ($YearOfStudy == '2') ? 'selected' : ''; ?>>Second Year</option>
        <option value="3" <?php echo ($YearOfStudy == '3') ? 'selected' : ''; ?>>Third Year</option>
        <option value="4" <?php echo ($YearOfStudy == '4') ? 'selected' : ''; ?>>Fourth Year</option>
        <option value="5" <?php echo ($YearOfStudy == '5') ? 'selected' : ''; ?>>Fifth Year</option>
        <option value="6" <?php echo ($YearOfStudy == '6') ? 'selected' : ''; ?>>Graduated</option>
      </select>
    ...
    <option value="Zimbabwean" <?php echo ($Nationality == 'Zimbabwean') ? 'selected' : ''; ?>>Zimbabwean</option>
      ...
      <label>Major:</label>
      <input type="text" name="Major" placeholder="Your major or field" value="<?php echo htmlspecialchars($Major); ?>" required>
      ...
      <label>GPA:</label>
      <input type="text" name="GPA" placeholder="Your GPA" value="<?php echo htmlspecialchars($GPA); ?>" required>
    ...
    <option value="Other" <?php echo ($Country == 'Other') ? 'selected' : ''; ?>>Other</option>
      ...
      <label>City:</label>
      <input type="text" name="City" placeholder="Your city" value="<?php echo htmlspecialchars($City); ?>" required>
